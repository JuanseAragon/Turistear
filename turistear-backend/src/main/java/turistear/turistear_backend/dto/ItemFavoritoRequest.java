...
/**
 * Body compartido para {@code POST /favoritos/\{id\}/items} y
 * {@code PUT /favoritos/\{id\}/items/\{itemId\}}.
 *
 * <p>Diseño PUT-completo: el cliente manda siempre el estado completo
 * deseado del item. No hacemos parches parciales (PATCH) para
 * mantener la API simple.
 */
public record ItemFavoritoRequest(
